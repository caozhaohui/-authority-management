...
public class JavaMailUtil {
    ...
    // 发件人的邮箱-修改为自己的
    public static String emailAccount = "1980162072@qq.com";
    // 发件人邮箱授权码-修改为自己的
    public static String emailPassword = "bjvjqqpwglakgdjf";
    // 发件人邮箱服务地址-修改为自己的
    public static String emailSMTPHost = "smtp.qq.com";
    //  收件人邮箱
    public static String receiveMailAccount = "lyyx97@163.com";
    ...
    public static  MimeMessage creatMimeMessage(Session session,String sendMail,String receiveMail,String html) throws MessagingException, IOException {
        ...
        // 2、From：发件人
        message.setFrom(new InternetAddress(sendMail, "lyyx97@163.com", "UTF-8"));
